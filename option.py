...
parser.add_argument('--patch_size', type=int, default=180,  # 输出patch大小
                    help='output patch size')
parser.add_argument('--rgb_range', type=int, default=1,  # RGB的最大值
...
# model 设置
parser.add_argument('--model', default='E_DUN',  # 使用的模型
                    help='model name')
...
parser.add_argument('--skip_threshold', type=float, default='1e6',  # 跳过错误较大的批处理
...
parser.add_argument('--print_every', type=int, default=400,  # 在记录训练状态之前需要等待多少批次
...
# options for test
parser.add_argument('--testset', type=str, default='Set14',  # 用于测试的数据集名称
