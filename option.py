...
parser.add_argument('--dir_demo', type=str, default='../DPDNN',
...
parser.add_argument('--patch_size', type=int, default=180,
...
parser.add_argument('--model', default='E_DUN',
                    help='model name')
...
parser.add_argument('--batch_size', type=int, default=4 * 3,
...
# Log specifications
parser.add_argument('--pre_train', type=str, default='experiment/SR_X2_BI/model/model_best.pt',
                    help='pre-trained model directory')
parser.add_argument('--save', type=str, default='../experiment/SR_X2_BI',
